...
/**
 * @type {Object}
 * pentamania's memo: 画像パスの指定先に注意すること
 */
...
enchant.ui.Button.DEFAULT_THEME = {
    ...
    nazrinBlue: {
        normal: {
            color: 'hsla(230,50%,70%,1.0)',
            background: { type: 'linear-gradient', start: 'hsla(230,50%,50%,1.0)', end: 'hsla(230,50%,50%,1.0)' },
            border: { color: '#026', width: 1, type: 'solid' },
            textShadow: { offsetX: 0, offsetY: 0, blur: 0, color: '#666' },
            boxShadow: { offsetX: 0, offsetY: 1, blur: 0, color: 'rgba(0, 0, 0, 0.5)' }
        },
        active: {
            color: '#ccc',
