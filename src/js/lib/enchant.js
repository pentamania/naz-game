...
/*
    * Customed by　pentamania
    * 2015/03/24
    * Customed method
    *  addChildren
    *
    *  WebAudioSound部分をv0.8.2から拝借
*/
...
enchant.Label = enchant.Class.create(enchant.Entity, {
    ...
    /*customed: get/set strokeStyle(color) of/on the text*/
    strokeColor: {
        get: function() {
    ...
    /*customed(pentamania): add strokeStyle(color) to the Text*/
    cvsRender: function(ctx) {
        var x, y = 0;
        ...
        if (this._splitText) {
            ...
            //ctx.textBaseline = 'middle'; //custom
            ctx.font = this.font;
            ctx.fillStyle = this.color || '#000000';
            ctx.strokeStyle = this.strokeColor || 'transparent'; //custom
